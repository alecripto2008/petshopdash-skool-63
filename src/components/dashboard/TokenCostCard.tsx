  ...
  return (
    ...
    >
      <CardContent className="p-6 text-center">
        <div className="bg-amber-100 dark:bg-amber-800 p-3 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">
          <Coins className="h-6 w-6 text-amber-600 dark:text-amber-300" />
        </div>
